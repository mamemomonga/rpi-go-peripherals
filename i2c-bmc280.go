...
func i2cBME280() {
	...
	for {
		...
		switch {
		case di <= 55:            dit = "寒い"
		case di > 55 && di <= 60: dit = "肌寒い"
		case di > 60 && di <= 65: dit = "何も感じない"
		case di > 65 && di <= 70: dit = "快適"
		case di > 70 && di <= 75: dit = "暑くない"
		case di > 75 && di <= 80: dit = "やや暑い"
		case di > 80 && di <= 85: dit = "暑くて汗が出る"
		case di > 85:             dit = "暑くてたまらない"
		}
